...
if __name__ == '__main__':
    ...
    parser.add_argument("--useThtAnchor",              action="store_true", help="Use footprint anchors for through-hole component positions")
    ...
    options[USE_THT_ANCHOR_OPT] = args.useThtAnchor
